...
🏆 2022 서울시 빅데이터 컨퍼런스 서울시 창조경제 혁신상(최우수) 수상 작품
...
* 9호선은 2009년 개통이후 꾸준히 '지옥철'타이틀을 유지해옴<br>
* 지하철 커뮤니티를 통해 9호선의 신설역 연장 개통에 이용객들의 부정적인 여론을 확인함 <br>
* 지하철 내부 혼잡은 더 나아가 장애인 시위로까지 이어질 수 있는 심각한 문제임을 확인함<br>
...
* 지하철 수요예측 관련 논문 리서치를 통해, 지하철 수요예측에 이용될 데이터 수집과 전처리 기법, EDA 그리고 모델링까지, 해당 프로젝트의 분석 프로세스를 기획<br>
* 신설역의 경우 과거 수요데이터가 없기 때문에 시계열 모델링이 아닌, 다양한 요인을 고려하여 예측 가능한 ML회귀모델로 접근할 것을 기획
